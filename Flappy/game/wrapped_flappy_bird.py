    ...
    def frame_step(self, input_actions):
        ...
        if input_actions[1] == 1:
            if self.playery > -2 * PLAYER_HEIGHT:
                ...
                self.player_rot += 10
                if self.player_rot >= PLAYER_ROT_THR:
                    self.player_rot = PLAYER_ROT_THR - 10
        ...
        visible_rot = self.player_rot if self.player_rot <= PLAYER_ROT_THR else PLAYER_ROT_THR
        player_surface = pygame.transform.rotate(
            IMAGES['player'][self.playerIndex],
            visible_rot,
        )
